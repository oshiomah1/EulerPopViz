...
# File paths
freq_file = "/quobyte/bmhenngrp/from-lssc0/projects/CAAPA2_functional_annotation/geovar/results/freq_mat_file_v2.csv"
...
geovar_test.add_freq_mat(freq_mat_file="/quobyte/bmhenngrp/from-lssc0/projects/CAAPA2_functional_annotation/geovar/results/freq_mat_file_v2.csv")

# now create a zipped version of the freq_mat_file in the results folder to use downstream
 
output_file = freq_file + ".gz"

with open(freq_file, "rb") as f_in:
    with gzip.open(output_file, "wb") as f_out:
        shutil.copyfileobj(f_in, f_out)

print("Gzipped:", output_file)

#STOP HERE FREQmat file and zipping complete
...
code_file = "/quobyte/bmhenngrp/from-lssc0/projects/CAAPA2_functional_annotation/geovar/results/allchr.txt"


geovar_code_counts.to_csv(code_file, sep=" ", header=False, index=False)
