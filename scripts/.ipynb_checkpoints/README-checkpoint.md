# Part 1 – Creating the Frequency Matrix with `1_geovar_script.py`

This document describes how to generate a **population frequency matrix** and **GeoVar counts file** from a VCF using the `1_geovar_script.py` script.
